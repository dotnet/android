...
class DataProviderXamarinAppMonoVM : DataProvider
{
	readonly AnELF elf;
	...
	public DataProviderXamarinAppMonoVM (Stream inputStream, string? inputPath, ILogger log)
	...
	public DSOCacheMonoVM? GetDSOCache ()
	{
		...
		return new DSOCacheMonoVM (Log, data, elf, symbolEntry);
	}
