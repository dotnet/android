...
namespace Xamarin.AndroidTools
{
	public static class ProcessUtils
	{
		...
		/// </summary>
		public static Task<TResult> ExecuteToolAsync<TResult> (string exe, ProcessArgumentBuilder args, Func<string, TResult> result, CancellationToken token, Action<Process> onStarted = null)
		{
