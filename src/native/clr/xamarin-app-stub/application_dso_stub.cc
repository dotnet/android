...
// This global is referenced by LLVM IR stubs generated by GenerateTypeMapAttributesStep
// and set directly from JNIEnvInit.Initialize out parameter (no typemap_init needed)
// Note: Named typemap_get_function_pointer to avoid conflict with legacy get_function_pointer symbol
[[gnu::visibility("default")]] get_function_pointer_typemap_fn typemap_get_function_pointer = nullptr;
