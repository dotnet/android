...
namespace xamarin::android {
	...
	private:
		...
		// Points at `_timing_instance` when fast timing is enabled, `nullptr` otherwise. The
		// instance is constant-initialized and lives for the whole lifetime of the process,
		// so there is nothing to allocate or free.
		static inline Timing _timing_instance {};
