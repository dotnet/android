...
namespace xamarin::android {
	...
	private:
		...
		static auto find_managed_to_java_map_entry (uint32_t name_hash, const char *type_name, size_t type_name_length, const TypeMapModuleEntry *map, size_t entry_count) noexcept -> const TypeMapModuleEntry*;
		...
		static auto find_java_to_managed_entry (uint32_t name_hash, const char *java_type_name, size_t java_type_name_length) noexcept -> const TypeMapJava*;
#else
