...
namespace xamarin::android {
	...
	private:
		...
		static auto open_file (LogCategories category, const char *custom_path, std::string_view const& override_dir, std::string_view const& fallback_filename) noexcept -> FILE*;
