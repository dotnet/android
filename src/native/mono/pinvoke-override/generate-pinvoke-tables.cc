...
const std::vector<std::string> internal_pinvoke_names = {
	...
	"_monodroid_register_reference_logging_callbacks",
...
const std::vector<std::string> dotnet_pinvoke_names = {
	...
	"SystemNative_LowLevelCrossProcessMutex_Acquire",
	"SystemNative_LowLevelCrossProcessMutex_Destroy",
	"SystemNative_LowLevelCrossProcessMutex_GetOwnerProcessAndThreadId",
	...
	"SystemNative_LowLevelCrossProcessMutex_SetAbandoned",
	"SystemNative_LowLevelCrossProcessMutex_SetOwnerProcessAndThreadId",
	"SystemNative_LowLevelCrossProcessMutex_Size",
