...
static class JniSignatureHelper
{
	...
	/// signatures. JNI boolean (Z) maps to <c>bool</c> (the MCW <c>n_*</c> callbacks declare the
	/// parameter as <see cref="bool"/>, unlike the blittable <c>byte</c> used for the UCO ABI).
