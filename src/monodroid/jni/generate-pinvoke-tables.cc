...
const std::vector<std::string> internal_pinvoke_names = {
	...
	"monodroid_javasystem_loadLibrary",
	"monodroid_log",
...
const std::vector<std::string> dotnet_pinvoke_names = {
	...
	"SystemNative_GetProcessArchitecture",
	...
	"AndroidCryptoNative_X509ChainSupportsRevocationOptions",
