...
{
	class TypeDetailsExtraParser : TypeDetailsParser
	{
		public PackageVendor Vendor { get; set; }

		public TypeDetailsExtraParser (ParserContext parserContext, XElement element, Dictionary<string, XNamespace> namespaces = null) : base (parserContext, element, namespaces)
		{}
		...
		{
			return new AndroidComponentInfoExtra (Type, Vendor);
		}
	}
}
