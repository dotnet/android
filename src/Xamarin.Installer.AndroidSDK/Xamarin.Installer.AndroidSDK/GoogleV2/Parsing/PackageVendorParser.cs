...
{
	class PackageVendorParser : ElementParser
	{
		string id;
		string display;
		...
		public PackageVendorParser (ParserContext parserContext, XElement element, Dictionary<string, XNamespace> namespaces = null) : base (parserContext, element, namespaces)
		{}
		...
		protected override void Parsed ()
		{
			...
			Vendor = new PackageVendor (id, display);
		}
	}
}
