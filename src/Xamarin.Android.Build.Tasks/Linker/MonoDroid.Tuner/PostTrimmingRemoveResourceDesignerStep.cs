...
/// <summary>
/// Post-trimming version of RemoveResourceDesignerStep that inlines resource designer
/// constants and removes designer classes, matching the original ILLink behavior.
/// The core logic is identical to the ILLink RemoveResourceDesignerStep / LinkDesignerBase.
/// </summary>
class PostTrimmingRemoveResourceDesignerStep : IAssemblyModifierPipelineStep
{
	...
	public PostTrimmingRemoveResourceDesignerStep (IList<AssemblyDefinition> allAssemblies, Action<string> logMessage)
	{
	...
	// ---- Methods below are from LinkDesignerBase / RemoveResourceDesignerStep, adapted for non-ILLink use ----
