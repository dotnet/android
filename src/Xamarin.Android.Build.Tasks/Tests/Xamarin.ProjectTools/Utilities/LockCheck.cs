...
// Also from: https://raw.githubusercontent.com/microsoft/msbuild/master/src/Tasks/LockCheck.cs
...
namespace Xamarin.ProjectTools
{
	public class LockCheck
	{
		...
		class ProcessInfo
		{
			public ProcessInfo (RM_PROCESS_INFO processInfo)
			{
		...
		static IEnumerable<ProcessInfo> GetLockingProcessInfos (params string [] paths)
		{
			if (paths == null) {
		...
		static Exception GetException (int res, string apiName, string message)
		{
			string reason;
			switch (res) {
