...
namespace Xamarin.Android.Build.Tests.Tasks {
	...
	public class GenerateJniRemappingNativeCodeTests : BaseTest {
		...
		public void EmptyCodeEmitsAllTablesAndZeroCounts ()
		{
			...
			StringAssert.Contains ("@jni_remapping_data = dso_local local_unnamed_addr constant %struct.JniRemappingData", ll);
			StringAssert.IsMatch (
				@"i32 0,\s+i32 0,\s+i32 0,\s+i32 0",
				ll,
				"The generated remapping data counts must all be zero.");
