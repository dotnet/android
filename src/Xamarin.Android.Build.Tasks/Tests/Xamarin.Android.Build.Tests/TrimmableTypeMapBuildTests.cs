		...
		public void PreGeneratedFrameworkTypeMapsMatchAppGeneratedMaps (string packageNamingPolicy)
		{
			...
			foreach (var fileName in new [] {
				...
				CollectionAssert.AreEqual (
					NormalizeModuleIdentity (generated),
					NormalizeModuleIdentity (preGenerated),
...
namespace UnnamedProject {
	...
	public class ConcreteProvider : AbstractProvider {
		...
		static byte [] NormalizeModuleIdentity (string assemblyPath)
		{
			...
			using var pe = new System.Reflection.PortableExecutable.PEReader (new MemoryStream (content, writable: false));
