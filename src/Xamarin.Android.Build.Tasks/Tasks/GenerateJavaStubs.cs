...
namespace Xamarin.Android.Tasks
{
	...
	public class GenerateJavaStubs : AndroidTask
	{
		...
		void Run (bool useMarshalMethods)
		{
			...
			if (useMarshalMethods) {
				...
				foreach (var kvp in javaStubStates) {
					RewriteMarshalMethods (kvp.Value, brokenExceptionTransitionsEnabled);
				}
			}
		...
		void RewriteMarshalMethods (JavaStubsState state, bool brokenExceptionTransitionsEnabled)
		{
			...
			var rewriter = new MarshalMethodsAssemblyRewriter (Log, state.TargetArch, state.Classifier);
