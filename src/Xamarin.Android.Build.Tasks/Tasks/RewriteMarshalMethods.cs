...
/// 2. Rewrites assemblies to replace dynamic registration with static marshal methods
/// 3. Reports statistics on marshal method generation and any fallback to dynamic registration
/// 
...
public class RewriteMarshalMethods : AndroidTask
{
	...
	/// 3. Report statistics on marshal method generation
	/// 4. Log warnings for methods that must fall back to dynamic registration
	/// </remarks>
	...
	/// </remarks>
	void RewriteMethods (NativeCodeGenState state)
	{
