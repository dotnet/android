	...
	partial class CompressedAssembliesNativeAssemblyGenerator : LlvmIrComposer
	{
		                               ...
		                               out List<LlvmIrGlobalVariable>? buffers)
		{
			...
			foreach (var kvp in assemblies) {
				...
				var bufferVar = new LlvmIrGlobalVariable (typeof(List<byte>), bufferName, LLVMIR.LlvmIrVariableOptions.LocalWritable) {
		...
		protected override void Construct (LlvmIrModule module)
		{
			...
			if (compressedAssemblyDescriptors == null) {
				module.AddGlobalVariable (
					...
					LLVMIR.LlvmIrVariableOptions.GlobalWritable
				);
				return;
			}

			module.AddGlobalVariable (CompressedAssembliesSymbolName, compressedAssemblies, LLVMIR.LlvmIrVariableOptions.GlobalWritable);
			module.AddGlobalVariable (DescriptorsArraySymbolName, compressedAssemblyDescriptors, LLVMIR.LlvmIrVariableOptions.LocalWritable);
