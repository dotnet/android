		...
		protected override void Construct (LlvmIrModule module)
		{
			...
			if (typeReplacements == null) {
				module.AddGlobalVariable (
					...
					LLVMIR.LlvmIrVariableOptions.GlobalConstant
				);
			...
			module.AddGlobalVariable (TypeReplacementsVariableName, typeReplacements, LLVMIR.LlvmIrVariableOptions.GlobalConstant);

			foreach (StructureInstance<JniRemappingIndexTypeEntry> entry in methodIndexTypes) {
				module.AddGlobalVariable (entry.Instance.MethodsArraySymbolName, entry.Instance.TypeMethods, LLVMIR.LlvmIrVariableOptions.LocalConstant);
			}

			module.AddGlobalVariable (MethodReplacementIndexVariableName, methodIndexTypes, LLVMIR.LlvmIrVariableOptions.GlobalConstant);
		}
