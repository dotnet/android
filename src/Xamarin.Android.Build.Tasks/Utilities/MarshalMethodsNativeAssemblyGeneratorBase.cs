...
{
	abstract partial class MarshalMethodsNativeAssemblyGeneratorBase : LlvmIrComposer
	{
...
#pragma warning restore CS0414
		...
		/// </summary>
		protected MarshalMethodsNativeAssemblyGeneratorBase (TaskLoggingHelper log, AndroidTargetArch targetArch, ICollection<string> uniqueAssemblyNames)
			: base (log)
		{
		...
		/// </summary>
		protected MarshalMethodsNativeAssemblyGeneratorBase (TaskLoggingHelper log, ICollection<string> uniqueAssemblyNames, NativeCodeGenStateObject codeGenState)
			: base (log)
		{
			this.uniqueAssemblyNames = uniqueAssemblyNames ?? throw new ArgumentNullException (nameof (uniqueAssemblyNames));
		...
		void AddMarshalMethod (LlvmIrModule module, MarshalMethodInfo method, ulong asmId, MarshalMethodsWriteState writeState)
		{
			...
			void WriteBody (LlvmIrFunctionBody body)
			{
				...
				var getFunctionPointerArguments = new List<object?> { placeholder, method.ClassCacheIndex, nativeCallback.MetadataToken, backingField };
