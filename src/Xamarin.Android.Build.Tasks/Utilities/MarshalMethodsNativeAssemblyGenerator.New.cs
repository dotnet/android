...
namespace Xamarin.Android.Tasks.New
{
	...
	partial class MarshalMethodsNativeAssemblyGenerator : LlvmIrComposer
	{
		...
		protected override void Construct (LlvmIrModule module)
		{
			...
			// class cache
			module.AddGlobalVariable ("marshal_methods_number_of_classes", (uint)classes.Count, LLVMIR.LlvmIrVariableOptions.GlobalConstant);
			module.AddGlobalVariable ("marshal_methods_class_cache", classes, LLVMIR.LlvmIrVariableOptions.GlobalWritable);
		...
		void AddMarshalMethodNames (LlvmIrModule module, AssemblyCacheState acs)
		{
			...
			var mm_method_names_variable = new LlvmIrGlobalVariable (mm_method_names, "mm_method_names", LLVMIR.LlvmIrVariableOptions.GlobalConstant) {
		...
		{
			var assembly_image_cache = new LlvmIrGlobalVariable (typeof(List<IntPtr>), "assembly_image_cache", LLVMIR.LlvmIrVariableOptions.GlobalWritable) {
			...
			var assembly_image_cache_hashes = new LlvmIrGlobalVariable (typeof(List<ulong>), "assembly_image_cache_hashes", LLVMIR.LlvmIrVariableOptions.GlobalConstant) {
			...
			var assembly_image_cache_indices = new LlvmIrGlobalVariable (typeof(List<uint>), "assembly_image_cache_indices", LLVMIR.LlvmIrVariableOptions.GlobalConstant) {
