...
#pragma warning restore 0649
		...
		static unsafe void RegisterJniNatives (IntPtr typeName_ptr, int typeName_len, IntPtr jniClass, IntPtr methods_ptr, int methods_len)
		{
			if (!RuntimeFeature.IsDynamicTypeRegistration) {
				throw new NotSupportedException ("Dynamic native member registration is not supported when Trimmable TypeMap is enabled. All types should be registered at build time.");
			}
