	...
	public partial class ValueAnimator
	{
		...
		public override unsafe Android.Animation.Animator SetDuration (long duration)
		{
			...
			try {
				...
				return global::Java.Lang.Object.GetObject<Android.Animation.Animator> (__rm.Handle, JniHandleOwnership.TransferLocalRef) ?? throw new InvalidOperationException ("Android.Animation.ValueAnimator.SetDuration returned null.");
			} finally {
			}
		}
