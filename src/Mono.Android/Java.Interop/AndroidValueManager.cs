...
{
	/// <summary>
	/// Unified JniValueManager implementation for Android that delegates peer creation to ITypeMap.
	/// This value manager works with both LlvmIrTypeMap (Mono) and 
	/// TypeMapAttributeTypeMap (NativeAOT/CoreCLR) implementations.
	/// </summary>
	class AndroidValueManager : JniRuntime.JniValueManager
	{
		readonly ITypeMap _typeMap;
		readonly Dictionary<IntPtr, IdentityHashTargets> instances = new Dictionary<IntPtr, IdentityHashTargets> ();
