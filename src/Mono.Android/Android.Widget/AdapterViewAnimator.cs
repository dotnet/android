			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (GetType () == typeof (AdapterViewAnimator<T>)) {
				if (id_ctor_Landroid_content_Context_ == IntPtr.Zero)
					id_ctor_Landroid_content_Context_ = JNIEnv.GetMethodID (_members.JniPeerTypeHandle, "<init>", "(Landroid/content/Context;)V");
				SetHandle (
						JNIEnv.NewObject (_members.JniPeerTypeHandle, id_ctor_Landroid_content_Context_, new JValue (context)),
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (GetType () == typeof (AdapterViewAnimator<T>)) {
				if (id_ctor_Landroid_content_Context_Landroid_util_AttributeSet_ == IntPtr.Zero)
					id_ctor_Landroid_content_Context_Landroid_util_AttributeSet_ = JNIEnv.GetMethodID (_members.JniPeerTypeHandle, "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V");
				SetHandle (
						JNIEnv.NewObject (_members.JniPeerTypeHandle, id_ctor_Landroid_content_Context_Landroid_util_AttributeSet_, new JValue (context), new JValue (attrs)),
						JniHandleOwnership.TransferLocalRef);
			} else {
				SetHandle (
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (GetType () == typeof (AdapterViewAnimator<T>)) {
				if (id_ctor_Landroid_content_Context_Landroid_util_AttributeSet_I == IntPtr.Zero)
					id_ctor_Landroid_content_Context_Landroid_util_AttributeSet_I = JNIEnv.GetMethodID (_members.JniPeerTypeHandle, "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V");
				SetHandle (
						JNIEnv.NewObject (_members.JniPeerTypeHandle, id_ctor_Landroid_content_Context_Landroid_util_AttributeSet_I, new JValue (context), new JValue (attrs), new JValue (defStyle)),
						JniHandleOwnership.TransferLocalRef);
			} else {
				SetHandle (
                ...
                public Android.Widget.IAdapter? Adapter {
                        ...
                        get {
                                if (id_getAdapter == IntPtr.Zero)
                                        id_getAdapter = JNIEnv.GetMethodID (_members.JniPeerTypeHandle, "getAdapter", "()Landroid/widget/Adapter;");
                        ...
                        set {
                                if (id_setAdapter_Landroid_widget_Adapter_ == IntPtr.Zero)
                                        id_setAdapter_Landroid_widget_Adapter_ = JNIEnv.GetMethodID (_members.JniPeerTypeHandle, "setAdapter", "(Landroid/widget/Adapter;)V");
