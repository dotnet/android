...
+ [XA4232](xa4232.md): The Android code generation target 'JavaInterop1' is no longer supported. Remove the '_AndroidJcwCodegenTarget' property or set it to 'XAJavaInterop1'.
