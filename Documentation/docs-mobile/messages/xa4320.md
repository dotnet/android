...
This diagnostic was retired when NativeAOT typemap extraction moved from the
DGML/ACW join to ILC object files. Current object extraction failures use
[XA4327](xa4327.md). The following describes the earlier DGML-based pipeline.
