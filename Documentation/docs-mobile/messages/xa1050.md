...
```dotnetcli
error XA1050: The 'AndroidR8ObfuscationMode' MSBuild property has an invalid value of 'private-member'. Valid values are 'disabled', 'private-members', and 'runtime-remapping'.
```
...
NativeAOT applications with trimmable type maps.
