...
For `<activity-alias>`, these type-name restrictions apply to `android:targetActivity`, not
`android:name`. The [alias name is an arbitrary component identifier](https://developer.android.com/guide/topics/manifest/activity-alias-element#nm)
and does not refer to a Java class.
