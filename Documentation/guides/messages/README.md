...
+ [XA4216](xa4216.md): Microsoft.Android 34.0.0 does not support a deployment target of '19' (the minimum is '21'). Please increase the $(SupportedOSPlatformVersion) property value in your project file.
