	...
	partial class AndroidToolchain : AppObject
	{
		...
		public AndroidToolchain ()
		{
			...
			Components = new List<AndroidToolchainComponent> {
				...
				new AndroidToolchainComponent ("x86-30_r05",                                        destDir: Path.Combine ("system-images", "android-30", "google_apis", "x86"), relativeUrl: new Uri ("sys-img/google_apis/", UriKind.Relative), pkgRevision: "5"),
				new AndroidToolchainComponent ($"x86_64-30_r05",                                    destDir: Path.Combine ("system-images", "android-30", "google_apis", "x86_64"), relativeUrl: new Uri ("sys-img/google_apis/", UriKind.Relative), pkgRevision: "5"),
