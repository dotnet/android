...
namespace Java.InteropTests
{
	...
	public class TrimmableTypeMapTypeManagerTests
	{
		...
		[Test]
		public void TryGetArrayProxy_ObjectLeaf_ReturnsRankOneTypes ()
		{
			AssumeTrimmableTypeMapEnabled ();
		...
		[Test]
		[Ignore ("Higher-rank reference array proxies are not generated by default; re-enable when the rank-2 object-array plan lands.")]
		public void TryGetArrayProxy_ObjectLeaf_ReturnsRankTwoTypes ()
		{
			AssumeTrimmableTypeMapEnabled ();
			AssumeGeneratedArrayProxiesEnabled ();
