	...
	public partial class Timing {
		...
		public virtual unsafe void VirtualVoidMethod_Timing_Traditional ()
		{
			if (jonp_id_VirtualVoidMethod == IntPtr.Zero)
				jonp_id_VirtualVoidMethod = JNIEnv.GetMethodID (_members.JniPeerTypeHandle, "VirtualVoidMethod", "()V");
		...
		{
			var m = JNIEnv.GetMethodID (_members.JniPeerTypeHandle, "VirtualVoidMethod", "()V");
		...
		public unsafe void VirtualVoidMethod_Timing_DictWithLock ()
		{
			...
			lock (dictInstanceMethods) {
				if (!dictInstanceMethods.TryGetValue (id, out m))
					dictInstanceMethods.Add (id, m = JNIEnv.GetMethodID (_members.JniPeerTypeHandle, "VirtualVoidMethod", "()V"));
			}
		...
		public unsafe void VirtualVoidMethod_Timing_ConcurrentDict ()
		{
			...
			var m = concurrentInstanceMethods.AddOrUpdate (id,
				s => JNIEnv.GetMethodID (_members.JniPeerTypeHandle, "VirtualVoidMethod", "()V"),
				(s, c) => c != IntPtr.Zero ? c : JNIEnv.GetMethodID (_members.JniPeerTypeHandle, "VirtualVoidMethod", "()V"));
