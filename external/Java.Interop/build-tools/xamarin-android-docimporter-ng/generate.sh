...
ANDROID_SDK_PATH=~/android-sdk-linux

DROID_DOC_API_LEVELS="10 15 16 17 18 19 20 21 22 23"
JAVA_STUB_API_LEVELS="24 25 26 27 P"


for n in $JAVA_STUB_API_LEVELS
do
	time mono --debug xamarin-android-docimporter-ng/bin/Debug/xamarin-android-docimporter-ng.exe -source-stub-zip=$ANDROID_SDK_PATH/platforms/android-$n/android-stubs-src.jar -output-text=api-$n.params.txt -output-xml=api-$n.params.xml -verbose -framework-only
done
