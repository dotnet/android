...
namespace generator.SourceWriters
{
	public class BoundAbstractProperty : PropertyWriter
	{
		...
		public BoundAbstractProperty (GenBase gen, Property property, CodeGenerationOptions opt)
		{
			...
			GetterAttributes.Add (new RegisterAttr (property.Getter.JavaName, property.Getter.JniSignature, UnmanagedCallbackSupport.GetConnectorNameFull (gen, property.Getter, opt), additionalProperties: property.Getter.AdditionalAttributeString ()) {
			...
			if (property.Setter != null) {
				...
				SetterAttributes.Add (new RegisterAttr (property.Setter.JavaName, property.Setter.JniSignature, UnmanagedCallbackSupport.GetConnectorNameFull (gen, property.Setter, opt), additionalProperties: property.Setter.AdditionalAttributeString ()) {
					MemberType	    = opt.CodeGenerationTarget != CodeGenerationTarget.JavaInterop1 ? null : (MemberTypes?) MemberTypes.Method,
				});
			}
		}
