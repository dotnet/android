...
- [How to build and run from source](https://github.com/xamarin/xamarin-android/wiki/How-to-Contribute#build-and-run)
- [The development workflow, and using your build](https://github.com/xamarin/xamarin-android/wiki/How-to-Contribute#using-your-build)
